...
// Captura o evento de inpuit para formatar o valor.
amount.oninput = () => {
...
// Captura o evento de submit do dormulario para obter os valores.
form.onsubmit = (event) => {
...
function updateTotals(){
    try {
        ...
        // Variavel para podedr incrementar o tatoal.
        let total = 0
...
expenseList.addEventListener("click", function (event) {
    // Verifica se o elemnto clicado é o icone de remover xizinho.
...
//
function formClear(){
    // Limpa os campos inputs do formulario.
    expense.value = ""
    category.value = ""
    amount.value = ""
